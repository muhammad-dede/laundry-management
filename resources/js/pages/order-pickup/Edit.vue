...
const form = useForm({
    customer_name: props.orderPickup?.customer?.name ?? "",
    customer_phone: props.orderPickup?.customer?.phone ?? "",
    customer_address: props.orderPickup?.customer?.address ?? "",
    courier_id: props.orderPickup?.courier_id ?? "",
    scheduled_at: props.orderPickup?.scheduled_at ?? "",
    notes: props.orderPickup?.notes ?? "",
});
...
const submit = () => {
    ...
    form.transform((data) => ({
        ...data,
    })).put(route("order-pickup.update", props.orderPickup.id));
};
...
const breadcrumbs = [
    { title: "Pickup Request", href: route("order-pickup.index") },
    {
        ...
        href: route("order-pickup.edit", props.orderPickup.id),
    },
];
</script>

<template>
    <Head title="Edit Pickup Request" />
