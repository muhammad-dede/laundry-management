...
function updateData() {
    ...
    router.get(route("expense.index"), query, {
        preserveState: true,
        replace: true,
    });
}
...
const destroy = () => {
    ...
    router.delete(route("expense.destroy", expense.value.id), {
        preserveScroll: true,
        onFinish: () => {
            closeDeleteModal();
        },
...
const breadcrumbs = [{ title: "Pengeluaran", href: route("expense.index") }];
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <AppMain>
            ...
            >
                <h2 class="text-lg md:text-xl font-bold">Kelola Pengeluaran</h2>
