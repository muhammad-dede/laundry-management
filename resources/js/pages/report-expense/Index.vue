...
const breadcrumbs = [
    { title: "Laporan Pengeluaran", href: route("report.expense.index") },
];
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <AppMain>
            <h2 class="text-lg md:text-xl font-bold">Laporan Pengeluaran</h2>
            <div class="flex flex-col md:flex-row md:items-end gap-3">
                ...
                <Button
                    v-if="can('report.expense.export')"
                    variant="outline"
